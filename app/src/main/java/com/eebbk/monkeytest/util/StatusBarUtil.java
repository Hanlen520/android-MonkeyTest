...
//		if (version > 21) {
//			setFullScreenWithTranslate(activity);
//		} else {
//			switchTransSystemUI(activity, true);
//		}
//		if (isLargerDevice(activity)) {
//			return;
//		}
//		View content = (View) activity.findViewById(android.R.id.content);
//		content.setSystemUiVisibility(SYSTEM_UI_FLAG_TRANSLUCENT_BAR | SYSTEM_UI_FLAG_CUSTOM_BAR_COLOR);
//		UtilsBar.setCustomBarColor(content, activity.getPackageName(), mCustomTypes, mCustomResNames);
        try {
...
//            setStatusBarColorMethod = Window.class.getDeclaredMethod("setStatusBarColor", int.class);
